 ...
 */
@interface NSObject(HXModel)
/**
 * 两个最常用的转model 方法, json, dictionary 转 model
 */
/**
 ...
 */
+ (nullable instancetype)hx_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)hx_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)hx_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)hx_modelSetWithDictionary:(NSDictionary *)dic;


/**
 * 对象转json对象, 以NSDic, NSArray形式
 */
/**
 ...
 */
- (nullable id)hx_modelToJSONObject;

/**
 * 对象转json数据, 以NSDic, NSArray形式
 */
/**
 ...
 */
- (nullable NSData *)hx_modelToJSONData;

/**
 * 对象转json数据, 以NSString形式
 */
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)hx_modelToJSONString;
 ...
 */
- (void)hx_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)hx_modelInitWithCoder:(NSCoder *)aDecoder;


/**
 * 对象的hash 一般在 hash方法只在对象被添加至NSSet和设置为NSDictionary的key时会调用
 * 为了优化查询
 */
/**
 ...
 */
- (BOOL)hx_modelIsEqual:(id)model;


/**
 * 这个很有用, 自己写model的时候不用再写 description或者 debugDescription了, 应该每个NSObject 都加上
 */
/**
 ...
 */
- (NSString *)hx_modelDescription;
@end

@interface NSArray (HXModel)
/**
 ...
 */
+ (nullable NSArray *)hx_modelArrayWithClass:(Class)cls json:(id)json;
@end

@interface NSDictionary (HXModel)
/**
 ...
 */
+ (nullable NSDictionary *)hx_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 * 在json-to-model转化的时候，通过该方法去实例不同的类类型
 * @param dictionary
 * @return
 */
...
/**
 * 生命周期在`+modelWithJSON:`, `+modelWithDictionary:`, `-modelSetWithJSON:` and `-modelSetWithDictionary:`之后
 */
/**
